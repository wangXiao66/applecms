<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"D:\phpstudy_pro\WWW\applecms(1)\applecms/application/admin\view\template\template.html";i:1602824619;s:80:"D:\phpstudy_pro\WWW\applecms(1)\applecms\application\admin\view\public\head.html";i:1602824618;s:80:"D:\phpstudy_pro\WWW\applecms(1)\applecms\application\admin\view\public\foot.html";i:1602824618;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
-->
                ...
                <div class="layui-form-item" style="margin-top: 1%;">
                    ...
                    <?php if(is_array($templates) || $templates instanceof \think\Collection || $templates instanceof \think\Paginator): $i = 0; $__LIST__ = $templates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <div style="width:100px; margin-left: 110px;float: left;" class="bg">
                        <img class="comment_pics" src="<?php echo $vo['image']; ?>/<?php echo $vo['name']; ?>.png" alt="" width="100px" height="150px"> 
                            <input type="radio" name="site[template_dir]" value="<?php echo $vo['name']; ?>" id=""  >
                    </div>
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="site[html_dir]" placeholder="html" value="html" class="layui-input w150" >
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function test_cache(){
        ...
        $.ajax({
            url: "<?php echo url('template/test_cache'); ?>",
            type: "post",
            dataType: "json",
