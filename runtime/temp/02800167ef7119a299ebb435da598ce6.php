<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"D:\phpstudy_pro\WWW\applecms(1)\applecms/application/admin\view\art\index.html";i:1602824619;s:80:"D:\phpstudy_pro\WWW\applecms(1)\applecms\application\admin\view\public\head.html";i:1602824618;s:80:"D:\phpstudy_pro\WWW\applecms(1)\applecms\application\admin\view\public\foot.html";i:1602824618;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="page-container p10">
    ...
    <div class="my-toolbar-box">
        ...
        <div class="layui-btn-group" style="margin-left: 38%;">
        ...
        <!--    <a data-href="<?php echo url('index/select'); ?>?tab=art&col=type_id&tpl=select_type&url=art/field" data-width="270" data-height="100" data-checkbox="1" class="layui-btn layui-btn-primary j-select"><i class="layui-icon">&#xe620;</i>分类</a>
            ...
            <a data-href="<?php echo url('index/select'); ?>?tab=art&col=art_lock&tpl=select_lock&url=art/field" data-width="470" data-height="100" data-checkbox="1" class="layui-btn layui-btn-primary j-select"><i class="layui-icon">&#xe620;</i>锁定</a>
    ...
    <form class="layui-form " method="post" id="pageListForm">
        <table class="layui-table" lay-size="sm">
            ...
            <tr>
                ...
                <td>[<?php echo $vo['type']['type_name']; ?>] <a target="_blank" class="layui-badge-rim " href="<?php echo mac_url_art_detail($vo); ?>"><?php echo htmlspecialchars($vo['art_name']); ?></a> <!--<?php if($vo['art_status'] == 0): ?> <span class="layui-badge">未审</span><?php endif; if($vo['art_lock'] == 1): ?> <span class="layui-badge">锁定</span><?php endif; ?>--></td>
