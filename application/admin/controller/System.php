...
class System extends Base
{
    ...
    public function config()
    {
        if (Request()->isPost()) {
            ...
            $config_old['site']['site_name'] = $config['site']['site_name'];
            $config_old['site']['site_url'] = $config['site']['site_url'];
            $config_old['site']['site_description'] = $config['site']['site_description'];
            $config_old['site']['site_keywords'] = $config['site']['site_keywords'];
            $config_old['site']['site_icp'] = $config['site']['site_icp'];
            $config_old['site']['site_qq'] = $config['site']['site_qq'];
            $config_old['site']['site_email'] = $config['site']['site_email'];
            $config_old['site']['install_dir'] = $config['site']['install_dir'];
            $config_old['site']['site_logo'] = $config['site']['site_logo'];
...
//        var_dump($templates);die;
        ...
        if(!$config['site']['site_name']) $config['site']['site_name'] = '';
        if(!$config['site']['site_url']) $config['site']['site_url'] = '';
        if(!$config['site']['site_description']) $config['site']['site_description'] = '';
        if(!$config['site']['site_keywords']) $config['site']['site_keywords'] = '';
        if(!$config['site']['site_icp']) $config['site']['site_icp'] = '';
        if(!$config['site']['site_qq']) $config['site']['site_qq'] = '';
        if(!$config['site']['site_email']) $config['site']['site_email'] = '';
        if(!$config['site']['install_dir']) $config['site']['install_dir'] = '';
        if(!$config['site']['site_logo']) $config['site']['site_logo'] = '';
    ...
    public function href_config()
    {
        ...
        if(Request()->isPost()){
            ...
            $config_old['site']['href1'] = $config['site']['href1'];

            $config_old['site']['href2'] = $config['site']['href2'];

            $config_old['site']['href3'] = $config['site']['href3'];

            $config_old['site']['href4'] = $config['site']['href4'];

            $config_old['site']['href5'] = $config['site']['href5'];

            $config_old['site']['href6'] = $config['site']['href6'];

            $config_old['site']['href7'] = $config['site']['href7'];

            $config_old['site']['href8'] = $config['site']['href8'];

            $config_old['site']['code'] = $config['site']['code'];
        ...
        return $this->fetch('admin@system/href_config');
