...
return array(
    ...
    '2' => array('name' => '系统参数配置', 'icon' => 'xe62e', 'sub' => array(
        '21' => array("show"=>1,'name' => '网站参数配置', 'controller' => 'system','action' => 'config'),
    )),


    '7' => array('name' => '模版', 'icon' => 'xe72d', 'sub' => array(
        '22' => array("show"=>1,'name' => '选择模板', 'controller' => 'template','action' => 'template'),
        /*'71' => array("show"=>1,'name' => '模板管理', 'controller' => 'template',		'action' => 'index'),*/
    )),

    '8' => array('name' => '链接-二维码配置', 'icon' => 'xe722', 'sub' => array(
        '81' => array("show"=>1,'name' => '链接-二维码配置', 'controller' => 'system','action' => 'href_config'),

    )),

    '9' => array('name' => '分类管理', 'icon' => 'xe64b', 'sub' => array(
        '91' => array("show"=>1,'name' => '添加分类', 'controller' => 'type','action' => 'info'),
        '92' => array("show"=>1,'name' => '分类列表', 'controller' => 'type','action' => 'index'),
    )),

    '10' => array('name' => '文章管理', 'icon' => 'xe736', 'sub' => array(
        '101' => array("show"=>1,'name' => '添加文章', 'controller' => 'art','action' => 'info'),
        '102' => array("show"=>1,'name' => '文章列表', 'controller' => 'art','action' => 'data'),
    )),
