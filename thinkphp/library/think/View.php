...
class View
{
    ...
    public function __construct($engine = [], $replace = [])
    {
        ...
        //查询出所有分类下的文章
         $news = db::name('type')
                ->alias('t')
                ->join('mac_art art','t.type_id = art.type_id')
                ->field('t.type_id,t.type_name,art.art_id,art.art_name,art.art_sub,art.art_en,art.art_pic,art.art_pic_thumb,art.art_blurb,art.art_content')
                ->select();
//         var_dump($news);die;
